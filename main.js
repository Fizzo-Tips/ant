...
global.authFile = `${opts._[0] || 'kibot'}.data.json`
...
// Menjalankan beberapa sesi
async function runSession(sessionName) {
    // Logika untuk memulai sesi WhatsApp dengan nama sessionName
    // Gunakan modul Baileys atau metode sesuai kebutuhan Anda
    console.log(`Memulai sesi: ${sessionName}`)
}
